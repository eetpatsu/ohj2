 ...
 * @version 2023.06.26 22:58:58 // Generated by ComTest
 *
 */
...
public class PunttisalimuistioTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testLueTiedostosta210 
   * @throws SailoException when error
   */
  @Test
  public void testLueTiedostosta210() throws SailoException {    // Punttisalimuistio: 210
    Punttisalimuistio muistio = new Punttisalimuistio(); 
    ...
    fail("Punttisalimuistio: 229 Did not throw SailoException");
    ...
    assertEquals("From: Punttisalimuistio line: 242", lii3T2.toString(), il.next().toString()); 
    assertEquals("From: Punttisalimuistio line: 243", lii4T2.toString(), il.next().toString()); 
    assertEquals("From: Punttisalimuistio line: 244", lii5T2.toString(), il.next().toString()); 
    assertEquals("From: Punttisalimuistio line: 245", false, il.hasNext()); 
    muistio.talleta(); 
    assertEquals("From: Punttisalimuistio line: 247", true, tiedostoT.delete()); 
    assertEquals("From: Punttisalimuistio line: 248", true, tiedostoL.delete()); 
    assertEquals("From: Punttisalimuistio line: 249", true, dir.delete()); 
  } // Generated by ComTest END
}
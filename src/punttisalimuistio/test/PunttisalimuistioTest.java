 ...
 * @version 2023.06.26 12:54:43 // Generated by ComTest
 *
 */
...
public class PunttisalimuistioTest {
   ...
   */
  @Test
  public void testGetTreeneja31() throws SailoException {    // Punttisalimuistio: 31
    ...
    assertEquals("From: Punttisalimuistio line: 37", 0, muistio.getTreeneja()); 
    muistio.lisaa(tre1); assertEquals("From: Punttisalimuistio line: 38", 1, muistio.getTreeneja()); 
    muistio.lisaa(tre2); assertEquals("From: Punttisalimuistio line: 39", 2, muistio.getTreeneja()); 
    muistio.lisaa(tre1); assertEquals("From: Punttisalimuistio line: 40", 3, muistio.getTreeneja()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testAnnaTreeni54() throws SailoException {    // Punttisalimuistio: 54
    Punttisalimuistio muistio = new Punttisalimuistio(); 
    Treeni tre1 = new Treeni(); 
    Treeni tre2 = new Treeni(); 
    tre1.rekisteroi(); tre2.rekisteroi(); 
  ...
  /** testLisaa114 */
  @Test
  public void testLisaa114() {    // Punttisalimuistio: 114
    Punttisalimuistio muistio = new Punttisalimuistio(); 
    Treeni tre1 = new Treeni(); 
    Treeni tre2 = new Treeni(); 
    tre1.rekisteroi(); tre2.rekisteroi(); 
    ...
    muistio.lisaa(tre1); muistio.lisaa(tre2); 
    muistio.lisaa(tre1); muistio.lisaa(tre2); 
    assertEquals("From: Punttisalimuistio line: 132", 13, muistio.getTreeneja()); 
  } // Generated by ComTest END
  ...
  /** testLisaa155 */
  @Test
  public void testLisaa155() {    // Punttisalimuistio: 155
    Liikkeet liikkeet = new Liikkeet(); 
    Liike lii1T1 = new Liike(1); 
    Liike lii2T1 = new Liike(1); 
    assertEquals("From: Punttisalimuistio line: 159", 0, liikkeet.getLkm()); 
    lii1T1.rekisteroi(); 
    liikkeet.lisaa(lii1T1); 
    assertEquals("From: Punttisalimuistio line: 162", 1, liikkeet.getLkm()); 
    lii2T1.rekisteroi(); 
    liikkeet.lisaa(lii2T1); 
    assertEquals("From: Punttisalimuistio line: 165", 2, liikkeet.getLkm()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLueTiedostosta200() throws SailoException {    // Punttisalimuistio: 200
    Punttisalimuistio muistio = new Punttisalimuistio(); 
    ...
    fail("Punttisalimuistio: 219 Did not throw SailoException");
    ...
    assertEquals("From: Punttisalimuistio line: 232", lii3T2.toString(), il.next().toString()); 
    assertEquals("From: Punttisalimuistio line: 233", lii4T2.toString(), il.next().toString()); 
    assertEquals("From: Punttisalimuistio line: 234", lii5T2.toString(), il.next().toString()); 
    assertEquals("From: Punttisalimuistio line: 235", false, il.hasNext()); 
    muistio.talleta(); 
    assertEquals("From: Punttisalimuistio line: 237", true, tiedostoT.delete()); 
    assertEquals("From: Punttisalimuistio line: 238", true, tiedostoL.delete()); 
    assertEquals("From: Punttisalimuistio line: 239", true, dir.delete()); 
  } // Generated by ComTest END
}
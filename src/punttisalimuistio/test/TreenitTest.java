 ...
 * @version 2023.06.27 14:52:34 // Generated by ComTest
 *
 */
...
public class TreenitTest {
  ...
  /** testPoista163 */
  @Test
  public void testPoista163() {    // Treenit: 163
    Treenit treenit = new Treenit(); 
    ...
    assertEquals("From: Treenit line: 169", 3, treenit.getLkm()); 
    assertEquals("From: Treenit line: 170", 1, treenit.poista(nro)); 
    assertEquals("From: Treenit line: 171", 2, treenit.getLkm()); 
    assertEquals("From: Treenit line: 172", 1, treenit.poista(nro+1)); assertEquals("From: Treenit line: 172", 1, treenit.getLkm()); 
    assertEquals("From: Treenit line: 173", 0, treenit.poista(nro+3)); assertEquals("From: Treenit line: 173", 1, treenit.getLkm()); 
    assertEquals("From: Treenit line: 174", 1, treenit.poista(nro+2)); assertEquals("From: Treenit line: 174", 0, treenit.getLkm()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLueTiedostosta195() throws SailoException {    // Treenit: 195
    Treenit treenit = new Treenit(); 
    ...
    assertEquals("From: Treenit line: 219", tre4.toString(), i.next().toString()); 
    assertEquals("From: Treenit line: 220", tre5.toString(), i.next().toString()); 
    treenit = new Treenit(); 
    i = treenit.iterator(); 
    assertEquals("From: Treenit line: 223", false, i.hasNext()); 
    treenit.lueTiedostosta(nimi); 
    treenit.lisaa(tre5); 
    treenit.talleta(nimi); 
    assertEquals("From: Treenit line: 227", true, tiedosto.delete()); 
    assertEquals("From: Treenit line: 228", true, dir.delete()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testEtsi301() throws SailoException {    // Treenit: 301
    Treenit treenit = new Treenit(); 
    Treeni tre1 = new Treeni(), tre2 = new Treeni(), tre3 = new Treeni(); 
    tre1.rekisteroi(); tre2.rekisteroi(); tre3.rekisteroi(); 
    int nro = tre1.getTunnusNro(); 
    treenit.lisaa(tre1); treenit.lisaa(tre2); treenit.lisaa(tre3); 
    assertEquals("From: Treenit line: 308", 1, treenit.etsi(nro+1)); 
    assertEquals("From: Treenit line: 309", 2, treenit.etsi(nro+2)); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testTreenitIterator347 
   * @throws SailoException when error
   */
  @Test
  public void testTreenitIterator347() throws SailoException {    // Treenit: 347
    Treenit treenit = new Treenit(); 
    ...
    assertEquals("From: Treenit line: 362", tulos, ids.toString()); 
    ids = new StringBuffer(30); 
    for (Iterator<Treeni> i = treenit.iterator(); i.hasNext(); ) { // ja iteraattorin toimintaa
    Treeni treeni = i.next(); 
    ids.append(" "+treeni.getTunnusNro()); 
    }
    assertEquals("From: Treenit line: 368", tulos, ids.toString()); 
    Iterator<Treeni>  i=treenit.iterator(); 
    assertEquals("From: Treenit line: 370", true, i.next() == tre1); 
    assertEquals("From: Treenit line: 371", true, i.next() == tre2); 
    assertEquals("From: Treenit line: 372", true, i.next() == tre1); 
    try {
    i.next(); 
    fail("Treenit: 373 Did not throw NoSuchElementException");
